...
class EnhancedGoldTradingEnvironment(gym.Env):
    ...
    def _get_observation(self):
        ...
        try:
            ...
            enhanced_sentiment, confidence = get_enhanced_sentiment(current_data_row)
        ...
        # 3. Определяем состояние портфеля (совместимое с оригинальной логикой)
        ...
        portfolio_state = np.array([
            ...
            self.position_size / (self.balance / current_price) if current_price > 0 else 0,  # Размер позиции
